...
<table style="margin: 0 auto; border-collapse: collapse; width: 100%;">
  <thead>
    <tr>
      <th style="text-align: center; padding: 8px; border: 1px solid #ddd;">时间</th>
      <th style="text-align: center; padding: 8px; border: 1px solid #ddd;">公司/部门</th>
      <th style="text-align: center; padding: 8px; border: 1px solid #ddd;">岗位</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="text-align: center; padding: 8px; border: 1px solid #ddd;">2016-2017</td>
      <td style="text-align: center; padding: 8px; border: 1px solid #ddd;"><code>青岛-海信集团-网络科技公司</code></td>
      <td style="text-align: center; padding: 8px; border: 1px solid #ddd;"><code>软件实习生</code></td>
    </tr>
    <tr>
      <td style="text-align: center; padding: 8px; border: 1px solid #ddd;">2017-2018</td>
      <td style="text-align: center; padding: 8px; border: 1px solid #ddd;"><code>北京-牛犇智能科技</code></td>
      <td style="text-align: center; padding: 8px; border: 1px solid #ddd;"><code>软件实习生</code></td>
    </tr>
    <tr>
